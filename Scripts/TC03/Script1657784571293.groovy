...
WebUI.setText(findTestObject('Page_STORE/input_Username_loginusername'), 'PRODSTORE')

WebUI.setEncryptedText(findTestObject('Page_STORE/input_Password_loginpassword'), '3AnazwqCE21a5WreA2C1iw==')
